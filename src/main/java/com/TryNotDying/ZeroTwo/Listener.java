...
public class Listener extends ListenerAdapter
{
                ...
                try
                {
                    ...
                    channel
                       .sendMessage(
                           ...
                           + "To give Zero-Two access to your Google account, go to "
    ...
    private void credit(JDA jda)
    {
        ...
        jda.getTextChannelById(119222314964353025L)
                .sendMessage("This account is running Zero-Two. Please do not list bot clones on this server, <@"+bot.getConfig().getOwnerId()+">.").complete();
        dbots.leave().queue();
    }
}