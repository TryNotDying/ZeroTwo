/*
 * Copyright 2016 TryNotDying (TryNotDying).
 *
...
public class ZeroTwo 
{
    ...
    private static void startBot()
    {
        ...
        Prompt prompt = new Prompt("ZeroTwo");
        ...
        try
        {
            ...
            {
                prompt.alert(Prompt.Level.ERROR, "ZeroTwo", "ZeroTwo cannot be run on this Discord bot: " + unsupportedReason);
            ...
            {
                LOG.info("ZeroTwo", "You currently have a custom prefix set. "
        ...
        {
            prompt.alert(Prompt.Level.ERROR, "ZeroTwo", ex + "\nPlease make sure you are "
        ...
        {
            prompt.alert(Prompt.Level.ERROR, "ZeroTwo", "Some aspect of the configuration is "
                    + "invalid: " + ex + "\nConfig Location: " + config.getConfigLocation());
            System.exit(1);
        }
    ...
    private static CommandClient createCommandClient(BotConfig config, SettingsManager settings, Bot bot)
    {
        ...
        AboutCommand aboutCommand = new AboutCommand(Color.BLUE.brighter(),
                                "a music bot that is [easy to host yourself!](https://github.com/TryNotDying/ZeroTwo) (v" + OtherUtil.getCurrentVersion() + ")",
