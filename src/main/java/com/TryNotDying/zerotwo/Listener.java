...
public class Listener extends ListenerAdapter
{
    ...
    public void onReady(ReadyEvent event) 
    {
        ...
        {
            Logger log = LoggerFactory.getLogger("ZeroTwo");
                ...
                try
                {
                    ...
                    channel
                       .sendMessage(
                           ...
                           + "To give ZeroTwo access to your Google account, go to "
    ...
    private void credit(JDA jda)
    {
        ...
        jda.getTextChannelById(119222314964353025L)
                .sendMessage("This account is running ZeroTwo. Please do not list bot clones on this server, <@"+bot.getConfig().getOwnerId()+">.").complete();
        dbots.leave().queue();
    }
}